package com.cheonho.di.mimic04;
...
class AppContext {
	...
	private void doComponentScan() {
		...
		try {
			...
			Set<ClassPath.ClassInfo> set = classPath.getTopLevelClasses("com.cheonho.di.mimic04");
...
public class DIMimic04 {
	public static void main(String[] args) {
		AppContext ac = new AppContext();
		Car car = (Car)ac.getBean("car");      // 이름 (id)으로 찾기 
		Engine engine = (Engine) ac.getBean("engine");
		
		Car car2 = (Car) ac.getBean(Car.class);    // 타입을 찾기
