...
public class DayOfTheWeek3 {
	...
	public void himedia(HttpServletRequest request) throws UnsupportedEncodingException {
		// 1. 입력
		...
		System.out.println("request.setCharacterEncoding():" + request.getCharacterEncoding());
