...
SELECT AVG(T.PAY_AMT)
FROM HM.TB_SAL_HIS T
WHERE T.PAY_DE = '20200525' 
;
...
--SELECT B.EMP_NO, B.EMP_NM, T.PAY_DE, T.PAY_AMT
--FROM TB_SAL_HIS T, TB_EMP B
--WHERE B.EMP_NO = ( 
--                   SELECT AVG(T.PAY_AMT)
--                   FROM HM.TB_SAL_HIS T
--				   WHERE T.PAY_DE = '20200525' 
...
-- Having절에서의 서브쿼리
-- 2020년 5월 25일 100004(디자인팀) 부서의 평균 급여보다 평균급여가 높은 부서의 
-- 부서코드와 부서명과 평균급여를 출력하시오.

-- 2020년 5월 25일 100004(디자인팀) 부서의 평균 급여 - 3462500
