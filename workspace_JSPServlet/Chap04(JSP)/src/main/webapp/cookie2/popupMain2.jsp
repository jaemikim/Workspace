  ...
  <script type="text/javascript">
  	$(function() {
  	  	$('#closeBtn').click(function() { /* 닫기 버튼을 누르면 */
  	  		...
  	  		let chkVal = $("input:checkbox[id=noToday]:checked").val();  /* 체크여부 chkVal에 "1"이 저장됨. */
  	  		$.ajax({ 							/*jQuery의 ajax() 함수로 비동기 요청*/
  	  			...
  	  			success : function(resData) {   /* 익명함수로 정의 */
...
<body>
	...
	<%
		for(int i = 1 ; i <= 10; i++) {
			out.print("현재팝업창은 " + popupMode + "상태입니다. <br />");
		}
		...
		<h2 align ="center">공지사항 팝업입니다.</h2>
			<div align ="right">
				<form action="" name = "popFrm">
					<input type="checkbox"  id="noToday"  value = "1"/> 오늘은 그만보기
