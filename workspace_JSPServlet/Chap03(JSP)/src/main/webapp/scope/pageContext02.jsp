...
<body>
	...
	%>
	<ul>
		<li>Integer 객체 : <%= (pageInteger == null) ? "값이 없음" : pageInteger %></li>
		<li>String 객체 : <%= (pageString == null) ? "값이 없음" : pageString %></li>
		<li>Person 객체 : <%= (pageDTO == null) ? "값이 없음" : ((PersonDTO)pageDTO).getName() %></li>
	</ul>
</body>
</html>