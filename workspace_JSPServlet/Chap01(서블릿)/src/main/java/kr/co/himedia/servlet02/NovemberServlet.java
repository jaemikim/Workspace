...
public class NovemberServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 웹 브라우저가 요청(GET /november?name=이순신)을 분석하면 name 변수에는 이순신이라는 문자값이 들어감		 
		String requestName = request.getParameter("name");		// request 객체를 통해 웹 브라우저가 전송한 데이터를 다를 수 있음
		 ...
		 * 바이너리 데이터(이미지 등)을 출력해야 한다면 ServletOutputStream
		 */
